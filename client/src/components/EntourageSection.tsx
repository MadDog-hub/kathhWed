    ...
    <section id="entourage" className="py-20 px-4 bg-background relative overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        <div className="animate-fade-up space-y-12 md:space-y-16">
          ...
          {/* Wedding Party */}
          <div className="border border-border rounded-2xl p-6 md:p-8 shadow-elegant bg-card">
            <h3 className="text-2xl md:text-3xl font-script italic text-primary mb-6 md:mb-8" data-testid="text-wedding-party-title">
              Para Saksihin ang Aming Panunumpa
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8 text-center mb-6 md:mb-8">
              <div>
                ...
                <p className="text-lg md:text-xl text-foreground" data-testid="text-best-man">Joemari Balaoro</p>
              </div>
              <div>
                ...
                <p className="text-lg md:text-xl text-foreground" data-testid="text-maid-of-honor">Michelle Cabrera</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 text-center mb-6 md:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8 text-center">
              <div>
                <h4 className="text-lg md:text-xl font-display font-semibold text-primary mb-3">Munting Binibini ng Bulaklak</h4>
